    ...
    <div className='check-challenge-section'>
      <img src={adImage} alt='advert' className='ad-image'/>
        ...
        <div className="challenge-requirements">
            <ul>
                <li className='requirement' >Pick a challenge task you are interested in</li>
                <li className='requirement'>Create  5 videos with the song and post it</li>
                <li className='requirement'>The more you create, the more you win!</li>
            </ul>
        </div>
