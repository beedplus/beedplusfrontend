...
import Sydney from "../SydneyHomeLogo/Sydney.jsx";
function TopPage() {
  return (
    <div className='top-page'>
        <img src={PlayIconTwo} alt="PlayIconOne" className='money' />
        <img src={PlayIconTwo} alt="PlayIconTwo" className='money2' />
        <img src={PlayIconTwo} alt="PlayIconOne" className='play-icon-one' />
        ...
        <div>
            <span className='header-secondline-styling'>AND GET $10  INSTANTLY</span>
